  ...
  return (
    <main className="public-page">
      ...
      <section className="public-card-grid">
        <article className="ds-card public-card"><Mail /><h2>General enquiries</h2><p>Email the team for school onboarding, pricing questions and partnerships.</p><a href="mailto:hello@alimswrite.com">hello@alimswrite.com</a></article>
