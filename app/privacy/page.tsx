  ...
  return (
    <main className="public-page legal-page">
      ...
      <section className="legal-content">
        ...
        <h2>Data sharing</h2><p>EduCore should not sell school, student or guardian data. Third-party services may be used for hosting, authentication, email, payments and analytics where required to operate the service.</p>
