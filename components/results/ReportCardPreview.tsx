  ...
  return (
    <div className="report-card-shell">
      ...
      <article className="report-card">
        <header>
          <div className="report-logo brand-report-logo"><EduCoreLogo href="" /></div>
        ...
        <footer><span><CalendarCheck size={15} /> Attendance verified</span><span>Generated by EduCore</span></footer>
      </article>
    </div>
  );
}
